...
- **Multiple Instances**: Supports multiple instances with different configurations.
...
You can initialize multiple instances of ApiKitClient with different configurations:
...
// Initialize a public instance without auth
ApiKitClient.initialize(
  "public",
  BASE_URL,
  () => false,
...
const updatedUser2: Partial<User> = {
  name: "Jane Doe",
};
